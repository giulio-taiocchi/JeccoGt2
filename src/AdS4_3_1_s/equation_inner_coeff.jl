...
ABCS[4] = x0 * (x4 + (-G * x3 + Gp) ^ 2) * (S0 * (xi + 1 / u) + S0_t)
...
x51 = 9 * x4
x52 = x46 + x50 + x51 + 3
x53 = u * (Bp * (-x43 - x49) + x17 * (x11 * x5 + x52) + x42) + x39
x54 = x14 * x5
x55 = S * x30
x56 = 16 * Bp * x55
x57 = 12 * xi
...
x129 = x35 * x37
x130 = S * x112 * xi
x131 = -B * x108 * x81 - 6 * Bp * x128 * x76 - Bp * x65 - 4 * Sp ^ 2 * x0 + x0 * x40 + x102 * x3 + x102 * x4 + x102 - 24 * x103 + x104 * x7 + x105 * x37 + x107 * x120 + x107 * x121 + x107 * x78 + x108 * x34 + x110 * x120 + x110 * x121 + x110 * x78 + 48 * x111 + x113 * x117 + x113 * x40 + x114 * x117 + x114 * x40 - 24 * x115 * x83 - x116 * x128 * x34 - x116 * x129 - x116 * x30 + x118 * x87 + x119 * x30 + x119 * x83 + x122 * x123 + x122 * x124 + x122 * x130 + x123 * x125 - x123 * x126 - x123 * x127 * x57 + x124 * x125 + x125 * x130 - x126 * x78 - 6 * x127 * x129 - 12 * x127 * x83 + 32 * x4 * xi + x40 * x83 * x90 + x40 * x88 + x40 * x91 - 16 * x44 * xi + 8 * xi
x132 = 2 * Gpp
x133 = x132 * x5
x134 = x100 * x25 * x7
x135 = -u * (Bp * (-x43 + x49) + x17 * (3 * B * x0 * x5 - x52) + x42) + x39
x136 = -x10 * x5 + x11 + 3 * x64 * xi + 3 * x95
x137 = x136 + x45
x138 = 2 * u
x139 = x44 - x69 + 1
x140 = -x139
...
x152 = cosh(x12) ^ 2
x153 = x138 * x152
x154 = u + x142 + x60 + x62 + x79 * x90
x155 = B_y * x16
x156 = Bp_y - x155
x157 = x2 * (B_x * x16 - Bp_x)
x158 = G * x138 + x97
x159 = B_x * x2
x160 = x0 * x159
x161 = x160 * x18
...
BB[1,1] = x21 * x6 * (x20 + 8)
BB[1,2] = -x29 * x31
CC[1,1] = x21 * (Bpp + x101 + x131 - x32 + x33 + x36 + x38 + x53 * x54 - x56 - x58 - x61 - x63 - x66 + x68 + x70 + x71 + x72 + x74 + x77 + x80 - x82 - x85 - x86 + x89 + x92 + x94 + x96)
CC[1,2] = -x41 * (x133 + x134 * x54 + x135 * x26 - x138 * (Gp * (-x137 + x47 + x48 + 5) + x98 * (x137 - x50 - x51 - 3)))
SS[1] = -4 * x140 * x21 * (S_x - x141 * xi_x) + x143 * (u * x140 * x27 * xi_y + u * x150 * x28 + x14 * x149 + x145 * (Spp - 4 * x103 + 6 * x111) + x146 * x147 + x149 + x151 * x153 * x18 * x2 + x2 * (S_x * x105 - 2 * Sp_x)) + x154 * (B_y * x0 * x29 - G_y * x23 + 2 * Gp_y + x134 * xi_y + x14 * x157 + x14 * x165 + x14 * x171 + x144 * x168 + x156 * x26 + x157 + x160 * x19 + x161 + x162 * x163 + x163 * x174 + x165 + x166 * x167 + x167 * x173 * x26 + x169 * x26 + x171 - x172 * x26 + x176 * x26 - xi_y * (12 * u * x158 + x132))
AA[2,1] = 0
AA[2,2] = x8
BB[2,1] = x177 * x31
BB[2,2] = -x6 * x9 * (x20 - 8)
CC[2,1] = x2 * x41 * (2 * x0 * x100 * x14 * x25 * x5 - x133 - x138 * (Gp * (-x136 - x49) + x98 * (x136 + x52)) + x26 * x53)
CC[2,2] = x9 * (-Bpp - x101 + x131 - x135 * x54 + x32 - x33 - x36 - x38 + x56 + x58 + x61 + x63 + x66 - x68 - x70 - x71 - x72 - x74 - x77 - x80 + x82 + x85 + x86 - x89 - x92 - x94 - x96)
SS[2] = 4 * x139 * x9 * (S_y - x141 * xi_y) + x143 * (S_y * x105 - 2 * Sp_y + u * x151 * x177 - x100 * x144 * x147 + x147 * x152 * x18 * xi_y + x148 * x27 + x150 * x153 * x25 + xi_y * (2 * Spp - 8 * x103 + 12 * x111)) + x154 * (B_y * x152 * x173 + Bp_y + x14 * x156 + x14 * x169 - x14 * x172 - x145 * (Gpp + x158 * x23) - x155 + x157 * x26 - x159 * x166 + x161 * x26 + x162 * (x27 + x99) + x165 * x26 + x167 * x19 * x7 + x168 * xi_y + x169 + x171 * x26 - x172 + x174 * x27 + x175 * x19 - x176 - x2 * (G_x * x23 - 2 * Gp_x))
