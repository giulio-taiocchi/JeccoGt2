...
@inline S_inner_to_outer(S_in, u, xi,S0,S0_t) =  1/u + xi + u*u*S_in
    #S0/u + S0*xi + S0_t + u*u*S_in
...
@inline A_inner_to_outer(A_in, u, xi, S0, S0_t, S0_tt, S0_x, S0_xx, S0_y, S0_yy) = 1/(u*u) + 2*xi/u + xi*xi + u * A_in #1/(u*u)+ (2*xi)/u + u*A_in + (S0 * S0*S0_t * S0_t - 2*S0*S0*S0*S0_tt + S0_x*S0_x + S0_y*S0_y- S0*(S0_xx + S0_yy) + S0*S0*S0*S0*(xi*xi))/(S0*S0*S0*S0)
...
@inline Sd_inner_to_outer(Sd_in, u, xi, S0, S0_t, S0_x, S0_xx, S0_y, S0_yy) = 1/(2*u*u) + xi/u + xi*xi/2  + u* Sd_in # sourceless	
