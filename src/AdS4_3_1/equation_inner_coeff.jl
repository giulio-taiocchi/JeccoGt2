...
x53 = 9 * x4
x54 = x48 + x52 + x53 + 3
x55 = u * (Bp * (-x45 - x51) + x17 * (x11 * x5 + x54) + x44) + x41
x56 = x14 * x5
x57 = Bp * x30
x58 = 16 * S * x57
x59 = 12 * xi
...
x126 = x85 * xi
x127 = S * x110 * xi
x128 = -B * Bp * x121 * x59 - 12 * B * S * x62 - B * x106 * x83 - Bp * x125 * x66 - 4 * Sp ^ 2 * x0 + x0 * x42 + x100 * x3 + x100 * x4 + x100 - 24 * x101 + x102 * x7 + x103 * x38 + x105 * x118 + x105 * x119 + x105 * x80 + x106 * x34 + x108 * x118 + x108 * x119 + x108 * x80 + 48 * x109 + x111 * x116 + x111 * x42 + x112 * x116 + x112 * x42 - 24 * x113 * x85 - x114 * x125 - x114 * x30 - x114 * x35 * x38 + x115 * x126 + x115 * x88 + x115 * x91 + x117 * x126 + x117 * x88 + x117 * x91 + x120 * x121 + x120 * x122 + x120 * x127 + x121 * x123 - x121 * x124 + x122 * x123 + x123 * x127 - x124 * x80 - x35 * x64 * x66 + 32 * x4 * xi - 16 * x46 * xi - x57 * x66 + 8 * xi
x129 = 2 * Gpp
x130 = x129 * x5
x131 = x25 * x7 * x98
x132 = -u * (Bp * (-x45 + x51) + x17 * (3 * B * x0 * x5 - x54) + x44) + x41
x133 = 3 * B
x134 = -x10 * x5 + x11 + x133 * x88 + x133 * x91
x135 = x134 + x47
x136 = 2 * u
x137 = x46 - x71 + 1
x138 = -x137
...
BB[1,1] = x21 * x6 * (x20 + 8)
BB[1,2] = -x29 * x31
CC[1,1] = x21 * (Bpp + x128 - x32 + x33 + x37 + x40 + x55 * x56 - x58 - x60 - x63 - x65 - x68 + x70 + x72 + x74 + x75 + x77 + x79 + x82 - x84 - x86 - x87 + x89 + x90 + x93 + x94 + x99)
CC[1,2] = -x43 * (x130 + x131 * x56 + x132 * x26 - x136 * (Gp * (-x135 + x49 + x50 + 5) + x96 * (x135 - x52 - x53 - 3)))
SS[1] = u * (x36 + x39 + x71 + x73 + x92 + 1) * (B_y * x0 * x29 - G_y * x152 + 2 * Gp_y + x131 * xi_y + x14 * x155 + x14 * x162 + x14 * x168 + x140 * x165 + x150 * x160 + x150 * x163 * xi_y + x154 * x26 + x155 + x158 * x19 + x159 + x162 + x163 * x164 + x164 * x170 * x26 + x166 * x26 + x168 - x169 * x26 + x172 * x26 - xi_y * (x129 + 12 * x156)) - 4 * x138 * x21 * (S_x - x139 * xi_x) + x151 * (u * x138 * x145 + u * x146 * x28 + x141 * (Spp - 4 * x101 + 6 * x109) + x143 * x97 + x144 * x150 + x144 * x25 + x147 * x149 * x18 * x2 + x2 * (S_x * x103 - 2 * Sp_x))
AA[2,1] = 0
AA[2,2] = x8
BB[2,1] = x173 * x31
BB[2,2] = -x6 * x9 * (x20 - 8)
CC[2,1] = x2 * x43 * (2 * x0 * x14 * x25 * x5 * x98 - x130 - x136 * (Gp * (-x134 - x51) + x96 * (x134 + x54)) + x26 * x55)
CC[2,2] = x9 * (-Bpp + x128 - x132 * x56 + x32 - x33 - x37 - x40 + x58 + x60 + x63 + x65 + x68 - x70 - x72 - x74 - x75 - x77 - x79 - x82 + x84 + x86 + x87 - x89 - x90 - x93 - x94 - x99)
SS[2] = u * x6 * (B_y * x148 * x170 + Bp_y + x14 * x154 + x14 * x166 - x14 * x169 - x141 * (Gpp + 6 * x156) + x145 * x163 - x153 + x155 * x26 - x157 * x163 + x159 * x26 + x160 * (x27 + x97) + x162 * x26 + x164 * x19 * x7 + x165 * xi_y + x166 + x168 * x26 - x169 + x171 * x19 - x172 - x2 * (G_x * x152 - 2 * Gp_x)) + 4 * x137 * x9 * (S_y - x139 * xi_y) + x151 * (S_y * x103 - 2 * Sp_y + u * x147 * x173 - x140 * x142 * x98 + x143 * x148 * x18 + x144 * x27 + x146 * x149 * x25 + xi_y * (2 * Spp - 8 * x101 + 12 * x109))
